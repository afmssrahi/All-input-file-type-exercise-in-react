...
const ModalBodyForDetailsUpdate = (props) => {
	console.log(props.updateFullFormValue);
			...
			<Modal.Body>
				...
				=================== */}
					<input
						...
						type='hidden'
						value={props.updateFullFormValue.id}
				...
				=================== */}
					...
					{errors.tel && (
						<p className='text-danger'>
							This field is required and expect tel/phone number
							with 11 digit
						</p>
					)}
					{/* Input type tel
...
export default ModalBodyForDetailsUpdate;
